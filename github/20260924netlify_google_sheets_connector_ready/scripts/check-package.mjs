...
const required=['netlify.toml','site/index.html','site/offerta.html','site/configurazione.html','site/gestione-ordini.html','site/giro-visite.html','site/config/companyConfig.js','site/offer-app.js','site/seed-data.json','netlify/functions/api.mjs'];
